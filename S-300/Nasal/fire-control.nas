...
var scan = func() {
	setprop("sim/multiplay/visibility-range-nm", 500);
	buildTargetList();
...
var missile_launch = func(mp, launchtime, my_pos) {
	...
	if (getprop("sam/timeleft") != 0) {
		...
		damage.damageLog.push("Fox 3 at: " ~ mp.getNode("callsign").getValue());
		...
		var a = getprop("controls/sounds/launch");
		setprop("controls/sounds/launch", !a);
